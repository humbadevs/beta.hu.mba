...
<div id="page" class="lg:h-screen">
      <div class="hidden md:flex md:flex-row md:pt-32 md:pb-32 md:px-20 bg-humba-pink">
        <div class="pt-8 md:w-2/6 xxl:w-1/6">
          ...
          <p class="font-extrabold text-white pt-6 text-s">humba ist die App mit der du dich mit den anderen Menschen aus deiner Schule auf eine leichte Art und Weise verbinden kannst. Digital, easy und spaßig.</p>
        </div>
      ...
      <div class="bg-humba-pink md:hidden text-white pt-8">
        ...
        <span class="block text-center m-6 pb-20">humba ist die App mit der du dich mit den anderen Menschen aus deiner Schule auf eine leichte Art und Weise verbinden kannst. Digital, easy und spaßig.</span>
      </div>
      <div class="pt-20">
