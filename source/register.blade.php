  ...
  <span class="block">
    <div class="md:flex md:pl-24 sm:block">
        ...
        <form action="https://api.hu.mba/waitinglist/apply/" method="post" class="flex justify-center md:block">
                <input required title="vorname.nachname" pattern="^([a-zA-Z\-]+)\.([a-zA-Z\.\-]+)" class="flex-1 mx-4 md:mx-0 shadow appearance-none border rounded-lg py-2 px-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type='text' placeholder="vorname.nachname" name="hum_id" size='23' maxlength="60"></input>
        </div>
